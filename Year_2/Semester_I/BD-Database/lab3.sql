...
SELECT r_id, name, phone, fax, adr_id
...
SELECT p_id, surname, first_name, sex, birthday, adr_id
	FROM public."Person"
	WHERE birthday>'12/31/1899' AND birthday<'01/01/2000';
