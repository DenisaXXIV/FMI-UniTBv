...
#define DELTA_WIDTH 80
#define DELTA_HEIGHT 60
...
void InitD3D(HWND hWnd)
{
	...
	CUSTOMVERTEX pTriangleVertices[] =
	{
		//coltul albastru
		{ SCREEN_WIDTH / 2.0,
		DELTA_HEIGHT - (DELTA_HEIGHT * 10 / 100),
		1.0f,
		1.0f,
		...
		//coltul verde
		{ SCREEN_WIDTH - DELTA_WIDTH,
		SCREEN_HEIGHT - DELTA_HEIGHT - ((SCREEN_HEIGHT - DELTA_HEIGHT) * 10 / 100),
		1.0f,
		1.0f,
...
void RenderFrame(void)
{
	...
	d3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(18, 104, 20), 1.0f, 0);
