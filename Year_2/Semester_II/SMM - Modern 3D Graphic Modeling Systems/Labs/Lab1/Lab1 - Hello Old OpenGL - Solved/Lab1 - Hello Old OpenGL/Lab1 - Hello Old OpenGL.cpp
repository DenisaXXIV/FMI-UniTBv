...
{
	glClearColor(0.0f, 0.0f, 255.0f, 1.0f); //culoarea neagru de fond a ecranului
}
...
void RenderFunction(void)
{
	...
	//varful din dreapta, jos
	glColor4f(0.0f, 255.0f, 0.0f, 1.0f);
	glVertex4f(0.8f, -0.8f, -0.0f, 1.0f);

	//vargul din dreapta, sus
	glColor4f(0.0f, 255.0f, 0.0f, 1.0f);
	glVertex4f(0.8f, 0.8f, -0.0f, 1.0f);

	//varful din stanga sus
	glColor4f(0.0f, 255.0f, 0.0f, 1.0f);
	glVertex4f(-0.8f, 0.8f, -0.0f, 1.0f);
