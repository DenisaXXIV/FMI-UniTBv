...
void drawFlower(Shader& shaderBlending, glm::mat4& model)
{
	const float pi = 3.1415;
	std::vector<float> angles =
	{
...
int main(int argc, char** argv)
{
	...
	if (std::string::npos != last_slash_idx)
	{
		...
		strSourcePath.append("\\Lab9 - Blending\\");
	}
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Lab9 - Blending", NULL, NULL);
	if (window == NULL)
	{
	...
	// Floor texture
	unsigned int floorTexture = CreateTexture(strSourcePath + "Textures\\ColoredFloor.png");

	// Grass texture
	unsigned int grassTexture = CreateTexture(strSourcePath + "Textures\\grass3.png");

	// Flower texture
	unsigned int flowerTexture = CreateTexture(strSourcePath + "Textures\\flower.png");
	...
	Shader shaderFlower((strSourcePath + "Shaders\\Flower.vs").c_str(),
		(strSourcePath + "Shaders\\Flower.fs").c_str());
	shaderFlower.SetInt("texture2", 0);
