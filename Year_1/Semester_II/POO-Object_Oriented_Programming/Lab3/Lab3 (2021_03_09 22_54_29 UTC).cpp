...
public:
	...
	///Supraincarcarea operatorilor ,,<<"/,,>>" pt afisare/citirea prin FUNCTII PRIETENE

	friend std::ostream& operator <<(std::ostream& out, Vect vect)
	{
		out << "(" << vect.getx() << "," << vect.gety() << "," << vect.getz() << ")" << std::endl;
		return out;
	}

	friend std::istream& operator >>(std::istream& in, Vect& vect)
	{
		in >> vect.cx >> vect.cy >> vect.cz;
		return in;
	}
};
...
//Supraincarcarea operatorilor ,,<<"/,,>>" pt afisare/citire in afara clasei

//std:: ostream& operator <<(std::ostream& out, Vect vect)
//{
//	out << "(" << vect.getx() << "," << vect.gety() << "," << vect.getz() << ")" << std::endl;
//	return out;
//}
//std::istream& operator >>(std::istream& in, Vect& vect)
//{
//	double x, y, z;
//	in >> x >> y >> z;
//	vect.Initializare(x, y, z);
//	return in;
//}

int main()
{
	Vect v, u, S, D, Pscal, vector;
	double P;
